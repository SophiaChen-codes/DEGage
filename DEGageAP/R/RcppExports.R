...
permtest <- function(genecount, group, levels, nperms) {
    .Call(`_DEGageAP_permtest`, genecount, group, levels, nperms)
}

DEGage_mean <- function(r1, p1, r2, p2) {
    .Call(`_DEGageAP_DEGage_mean`, r1, p1, r2, p2)
}

DEGage_var <- function(r1, p1, r2, p2) {
    .Call(`_DEGageAP_DEGage_var`, r1, p1, r2, p2)
}

DEGage_cdf <- function(r1, p1, r2, p2, k) {
    .Call(`_DEGageAP_DEGage_cdf`, r1, p1, r2, p2, k)
}
